...
$r = crs_call(["func"=>4, "codiClient"=>$codiClient]);

include __DIR__ . '/header.php';
?>

    <h2>Les meves reserves (PMS)</h2>
    ...
    <div class="card">
        ...
        <?php else: ?>
            ...
            <?php if (($data["idresp"] ?? "") !== "R4OK"): ?>
                ...
                <pre><?= h(json_encode($data, JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT)) ?></pre>
            <?php else: ?>
                <table>
                    <thead>
                    <tr>
                        <th>Codi</th><th>Entrada</th><th>Sortida</th><th>Estat</th><th>Hotel</th><th>Tipus</th><th>Règim</th>
                    </tr>
                    </thead>
                    <tbody>
